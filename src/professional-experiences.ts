...
const recentProfessionalExperiences: Item[] = [
    {
        ...
        usedTechnologies: [SiReact, SiJavascript, SiPython, SiDjango, SiPostgresql, SiDocker, SiGitlab, SiAnsible],
    },
    {
    ...
    },
    {
        ...
        content: "Worked as a *software engineer* at Map E-Commerce & Data Services Inc. Worked on *data flow and data processing pipelines and supply chain applications*.",
